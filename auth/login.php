...
<body>
  ...
  <main class="auth-container">
    <div class="auth-hero">
      <h1>Welcome Back to UniMarket</h1>
      <p>Login to buy and sell with fellow RUET students!</p>
    </div>
    <div class="auth-card">
      <h2>Login</h2>
      <?php if ($errors): ?>
      ...
      <p>New here? <a href="signup.php" class="link">Sign Up</a></p>
    </div>
  </main>
  ...
  <footer class="footer">
    <div class="footer-container">
      <div class="footer-section">
        ...
        <p>+8801745-706878</p>
        <a href="mailto:sabbirfr09@gmail.com" class="footer-link">Send us a message</a>
      </div>
      <div class="footer-section">
